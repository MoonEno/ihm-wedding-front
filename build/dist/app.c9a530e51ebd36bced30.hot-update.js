...
var Main = function Main() {
  var setLayout = function setLayout() {
    var _iterator = _createForOfIteratorHelper(sceneInfo.length),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var scence = _step.value;
