...
var Main = function Main() {
  var _useState = (0,react.useState)([]),
      ...
      sceneInfo = _useState2[0],
      setSceneInfo = _useState2[1];
  ...
  var setInit = function setInit() {
    ...
    setSceneInfo(initData);
  };

  var setLayout = function setLayout() {
    console.log("timing2");

    var tmpSceneInfo = _.cloneDeep(sceneInfo);

    tmpSceneInfo.map(function (i) {
      i.scrollHeight = i.heightX * window.innerHeight;
      i.obj.container.style.height = "".concat(i.scrollHeight, "px");
    });
    setSceneInfo(tmpSceneInfo);
  };
