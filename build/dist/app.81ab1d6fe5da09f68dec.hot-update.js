...
var Main = function Main() {
  ...
  var setLayout = function setLayout() {
    ...
    cp.map(function (i) {
      i.obj.container.style.height = "".concat(window.innerWidth * i.scrollHeight, "px");
    });
    setScene(cp);
  };
