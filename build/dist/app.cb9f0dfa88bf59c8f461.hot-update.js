...
var Main = function Main() {
  ...
  var setLayout = function setLayout() {
    scene.map(function (i) {
      console.log(i); //i.obj.container.style.height = `${i.scrollHeight}px`;
    });
  };
