...
var Main = function Main() {
  ...
  var yOffset = 0;
  var totalYOffset = 0; // 페이지 토탈 스크롤 길이

  var prevScrollHeight = 0; // 현재 스크롤 위치 이정보다 위치한 스크롤 섹션의 총 합

  var currentScene = 0; // 현재 액티브중인 씬
  // 화면별 컨텐츠 레이아웃 세팅
