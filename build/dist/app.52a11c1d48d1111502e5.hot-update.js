...
var Main = function Main() {
  ...
  var setLayout = function setLayout() {
    sceneInfo.map(function (i) {
      ...
      console.log(i.obj.container); //    i.obj.container.style.height = `${i.scrollHeight}px`;
    });
  };
