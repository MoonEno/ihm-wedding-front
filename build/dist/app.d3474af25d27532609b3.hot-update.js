...
var Main = function Main() {
  ...
  var curScene = function curScene() {
    ...
    for (var i = 0; i < currentScene; i++) {
      ...
      console.log(prevHeight, scene[i]);
    }
