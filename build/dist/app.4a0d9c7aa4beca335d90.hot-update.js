...
var Main = function Main() {
  ...
  var setLayout = function setLayout() {
    scene.map(function (i, idx) {
      ...
      cp.obj.container.style.height = cp.scrollHeight;
      console.log(cp);
