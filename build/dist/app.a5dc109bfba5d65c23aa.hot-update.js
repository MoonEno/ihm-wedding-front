...
var Main = function Main() {
  (0,react.useEffect)(function () {
    ...
    var setLayout = function setLayout() {
      for (var scence in sceneInfo.length) {
        scence.scrollHeight = scene.heightX * window.innerHeight;
      }
    };
