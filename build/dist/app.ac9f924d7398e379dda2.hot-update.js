...
var Main = function Main() {
  ...
  var setLayout = function setLayout() {
    ...
    scene.map(function (i, idx) {
      ...
      setScene(_objectSpread({}, scene), cp);
    });
  ...
  var curScene = function curScene() {
    ...
    for (var i = 0; i < currentScene; i++) {
      console.log("currentC", currentScene);
      prevHeight += scene[i].scrollHeight;
      console.log("scene", scene[i]);
    }

    console.log("prevHeight", prevHeight);

    if (yOffset > prevHeight + scene[currentScene].scrollHeight) {
      setCurrentScene((+currentScene, _readOnlyError("currentScene")));
    }
