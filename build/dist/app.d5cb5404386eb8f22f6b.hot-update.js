...
var Main = function Main() {
  ...
  (0,react.useEffect)(function () {
    setLayout();
    window.addEventListener('resize', setLayout); // 스크롤 컨트롤
